...
# ==================================================
# Link Hosting Kalian
test1="raw.githubusercontent.com/wonderfulgo/kampret/main"
...
curl https://${test1}/nginx1.conf > /etc/nginx/nginx.conf
curl https://${test1}/vps.conf > /etc/nginx/conf.d/vps.conf
...
wget -O /home/vps/public_html/index.html "https://${test1}/index.html1"
