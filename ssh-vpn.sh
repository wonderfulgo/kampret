...
state=Indonesia
locality=Indonesia
organization=SweetieSSH
organizationalunit=SweetieSSH
commonname=SweetieSSH
email=admin@SweetieSSH

# simple password minimal
wget -O /etc/pam.d/common-password "https://raw.githubusercontent.com/wonderfulgo/kampret/main/password"
...
echo "echo by SweetieSSH" >> .profile
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/wonderfulgo/kampret/main/nginx.conf"
mkdir -p /home/vps/public_html
echo "
<br> <br> <br> <br> <br> <br> <center><h1>Setup By SweetieSSH</h1></center>
<center><h1>Telegram = <a href='https://t.me/SweetieSSH'> Click </a></h1></center>
" > /home/vps/public_html/index.html
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/wonderfulgo/kampret/main/vps.conf"
/etc/init.d/nginx restart

# install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/wonderfulgo/kampret/main/badvpn-udpgw64"
...
wget -O /etc/squid/squid.conf "https://raw.githubusercontent.com/wonderfulgo/kampret/main/squid3.conf"
...
#OpenVPN
#wget https://raw.githubusercontent.com/wonderfulgo/kampret/main/vpn.sh &&  chmod +x vpn.sh && ./vpn.sh
